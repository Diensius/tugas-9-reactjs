...
const gabungKata = `${word} ${second} ${third} ${fourth} ${fifth} ${sixth} ${seventh}`
...
console.log(`${kataPertama} ${kataKedua.substring(0,1).toUpperCase()}${kataKedua.substring(1)} ${kataKetiga} ${kataKeempat.toUpperCase()}`);
...
let luasSegitiga = (parseInt(alasSegitiga) * parseInt(tinggiSegitiga));
